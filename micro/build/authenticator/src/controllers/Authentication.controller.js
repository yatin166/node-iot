...
var AuthenticationController = /** @class */ (function () {
    function AuthenticationController(router, loginService, registerService) {
        this.router = router;
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.loginService.login(req.body)
                    .then(function (loginResponse) { return res.send(loginResponse); })
                    .catch(function (error) { return next(error); });
                return [2 /*return*/];
            });
        });
    };
    AuthenticationController.prototype.getAccessToken = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.loginService.getAccessToken(req.body)
                    .then(function (loginResponse) { return res.send(loginResponse); })
                    .catch(function (error) { return res.json({ message: 'Token Invalid' }); });
                return [2 /*return*/];
            });
        });
    };
