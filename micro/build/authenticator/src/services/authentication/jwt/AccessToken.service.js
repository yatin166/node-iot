...
var AccessTokenServiceImpl = /** @class */ (function (_super) {
    ...
    AccessTokenServiceImpl.prototype.getToken = function (payload) {
        return this.create(payload, Token_config_1.TokenConfig.accessToken());
    };
    AccessTokenServiceImpl.prototype.verifyToken = function (token) {
